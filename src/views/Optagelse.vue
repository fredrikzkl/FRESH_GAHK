                ...
                <div id="description-content">
                  ...
                  <div class="md-layout" style="text-align:left">
                    <div class="md-layout-item md-size-50 md-small-size-100 ml-auto">
                      ...
                      <p>Indstillingen består af fire beboere på kollegiet, der varetager kontakten til potentielle nye beboere. Gruppen står for rundvisning og eventuel optagelse på baggrund af indsendte ansøgninger.</p>
                      <p>Første skridt er at se, om du opfylder kriterierne for at søge ind på kollegiet. Dem kan du læse nedenfor. Derefter kan du booke en rundvisning ved at udfylde formularen. Indstillingen kan herefter kontakte dig med henblik på en rundvisning, hvis der er udsigt til ledige værelser. På rundvisningen kan du få et bedre indtryk af husets atmosfære, værelserne og de mange traditioner, som vi værner om.</p>
                      <p>Efter rundvisningen får du tilsendt ansøgningsskema, som du kan udfylde med en motiveret ansøgning, hvis du synes om stedet og kunne tænke dig at bo sammen med os.</p>
                    </div>
                    <div
                      class="md-layout-item md-size-50 md-medium-size-50 md-small-size-100 mr-auto"
                    >
                      <h3>Kriterier</h3>
                   <p>Vi modtager ansøgninger fra studerende der er påbegyndt 3. semester på en længere videregående uddannelse såsom DTU, KU, SDU, AU, AAU, RUC, CBS, KA og de videregående kunstskoler som RMC, DDSKS, KADK, Københavns Kunstskole, Filmskolen osv.</p>
                    <p>2/3 af værelserne er forbeholdt studerende ved Danmarks Tekniske Universitet, hvorfor der i perioder kun kan optages DTU-studerende.</p>
                    <p>Vi foretrækker, at ansøgere er dansktalende, da det vil gøre det nemmere for alumnen at deltage i kollegielivet. /We prefer that our residents speak Danish, since the daily life at the kollegium is a lot easier to particitate in with understanding of the daily spoken language. </p>
                    </div>
                  </div>
                    ...
                    <div class="md-layout">
                      ...
                      >
                        ...
                        <md-field :class="getValidationClass('horteOm')">
                          ...
                          <span class="md-error" v-if="!$v.form.horteOm.required">Vælg en påstand</span>
                        </md-field>
